...
<form name="customer_form" method="post" action="customer_insert_db.jsp">
	<table>
		...
		<tr>
			<th>성 &nbsp; 별 &nbsp;&nbsp;</th>
			<td>
				<input type="radio" name="cust_gender" value="M"> 남자 &nbsp;
		...
		<tr>
			<th>이 메 일</th>
			<td>
				<input type="text" name="cust_email_1" size="15" maxlength="10" style="ime-mode:disabled">@
				<input type="text" name="cust_email_1" size="20" maxlength="20" style="ime-mode:disabled">
			</td>
		</tr>
